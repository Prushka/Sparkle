...
ARG SERVER_INTERNAL_BE=http://sparkle-api:1323
ARG SERVER_INTERNAL_STATIC=http://sparkle-api:1323/static
ARG PUBLIC_DISCORD_CLIENT_ID=

ENV NODE_OPTIONS="--max_old_space_size=4096"
ENV NEXT_TELEMETRY_DISABLED=1
ENV SERVER_BE=$SERVER_BE
ENV SERVER_STATIC=$SERVER_STATIC
ENV SERVER_INTERNAL_BE=$SERVER_INTERNAL_BE
ENV SERVER_INTERNAL_STATIC=$SERVER_INTERNAL_STATIC
